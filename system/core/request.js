...
= me.handleRequest = function f_request_handleRequest($requestState) {
    ...
    //TODO: This is a really dirty fix for waiting for the POST body :/
    var dirtyWaitForPOST = () => {
    ...
    _parseRequestBody($requestState).then(dirtyWaitForPOST, dirtyWaitForPOST);
};
